...
let CreateOrgDto = (() => {
    ...
    return _a = class CreateOrgDto {
        ...
        (() => {
            ...
            _slug_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(1), (0, class_validator_1.Matches)(/^[a-z0-9-]+$/, { message: 'slug must be lowercase alphanumeric and hyphens only' })];
